...
public class KnownUrl {
  ...
  public static final DateFormat shortFormat = new SimpleDateFormat(
          "yyMMddHHmm");
  ...
  public static String getUrl(String productDescription, String timeDescription)
    ...
    case "latest":
      break;
    default:
      String thisYear = new SimpleDateFormat("yyyy").format(new Date()).substring(2,4);
      if (timeDescription.startsWith(thisYear)) {
        Date dateTime = shortFormat.parse(timeDescription);
