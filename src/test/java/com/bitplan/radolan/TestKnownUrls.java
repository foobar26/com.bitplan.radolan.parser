...
public class TestKnownUrls extends BaseTest {
  ...
  public void testKnownUrls() throws Exception {
    ...
    for (String product : products) {
      ...
      String ago2hString = KnownUrl.shortFormat.format(ago2hDate);
      assertEquals(String.format("%02d%02d%02d%02d%02d", ago2h.getYear() % 100,
  ...
  public void testHistory() throws Exception {
    ...
    String [] times= {KnownUrl.shortFormat.format(DateUtils.asDate(LocalDateTime.now().minusMonths(2))),KnownUrl.shortFormat.format(DateUtils.asDate(LocalDateTime.now().minusMonths(3).minusDays(3)))};
